...
namespace Terraria
{
	internal class WorldGen
	{
		...
		public static void SpawnNPC(int x, int y)
		{
			...
			if (WorldGen.hiScore > 0)
			{
				...
				if (num == -1)
				{
					...
					if (Main.netMode == 0)
					{
						Main.NewText(str + " " + Lang.misc[18], 50, 125, 255);
					}
					else
					{
						if (Main.netMode == 2)
		...
		public static bool meteor(int i, int j)
		{
			...
			if (Main.netMode == 0)
			{
				Main.NewText(Lang.gen[59], 50, 255, 130);
			}
			else
			{
				if (Main.netMode == 2)
		...
		public static void generateWorld(int seed = -1)
		{
			...
			{
				int arg_6EEB_0 = Main.maxTilesX / 2;
				int num311 = WorldGen.genRand.Next(Main.maxTilesX);
				int num312 = num311 - WorldGen.genRand.Next(10) - 7;
				int num313 = num311 + WorldGen.genRand.Next(10) + 7;
				if (num312 < 0)
				{
					num312 = 0;
				}
				if (num313 > Main.maxTilesX - 1)
				{
					num313 = Main.maxTilesX - 1;
				}
				for (int num314 = num312; num314 < num313; num314++)
				{
					int num315 = 1;
		...
		public static void smCallBack(object threadContext)
		{
			...
			if (Main.netMode == 0)
			{
				Main.NewText(Lang.misc[15], 50, 255, 130);
			}
			else
			{
				if (Main.netMode == 2)
		...
		public static bool OpenDoor(int i, int j, int direction)
		{
			...
			if (flag)
			{
				...
				Main.tile[num3 + 1, num].frameX = (short)(num2 + 18);
				...
				Main.tile[num3 + 1, num + 1].frameX = (short)(num2 + 18);
				...
				Main.tile[num3 + 1, num + 2].frameX = (short)(num2 + 18);
		...
		public static void SmashAltar(int i, int j)
		{
			...
			if (num == 0)
			{
				if (Main.netMode == 0)
				{
					Main.NewText(Lang.misc[12], 50, 255, 130);
				}
				else
				{
					if (Main.netMode == 2)
					{
						NetMessage.SendData(25, -1, -1, Lang.misc[12], 255, 50f, 255f, 130f, 0);
					}
				}
				num = 107;
				num3 *= 1.05f;
			...
			else
			{
				if (num == 1)
				{
					if (Main.netMode == 0)
					{
						Main.NewText(Lang.misc[13], 50, 255, 130);
					}
					else
					{
						if (Main.netMode == 2)
						{
							NetMessage.SendData(25, -1, -1, Lang.misc[13], 255, 50f, 255f, 130f, 0);
						}
					}
					num = 108;
				}
				else
				{
					if (Main.netMode == 0)
					{
						Main.NewText(Lang.misc[14], 50, 255, 130);
					}
					else
					{
						if (Main.netMode == 2)
						{
							NetMessage.SendData(25, -1, -1, Lang.misc[14], 255, 50f, 255f, 130f, 0);
						}
					}
					num = 111;
				}
