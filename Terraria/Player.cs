			...
			if (this.active)
			{
				...
				else
				{
					if (i == Main.myPlayer)
					{
						...
						if (Main.hasFocus)
						{
							if (!Main.chatMode && !Main.editSign)
							{
                                ...
                                Vector2 t_position = Main.player[Main.myPlayer].position;

                                //temp velocity
                                float t_velocity = 10f;
								...
								for (int k = 0; k < pressedKeys.Length; k++)
								{
									...
									if (a == Main.cUp)
									{
                                        //if noclip, just change position
                                        if (Mod.NoClip)
                                        {
                                            t_position.Y -= t_velocity;
                                        }
                                        else
                                        {
                                            this.controlUp = true;
                                ...
                                //if noclip, apply new position
                                if (Mod.NoClip)
                                {
                                    Main.player[Main.myPlayer].position = t_position;
                                }
							}
							if (this.confused)
							{
                            ...
                            int MouseX = (int)((float)Main.mouseX + Main.screenPosition.X);
                            int MouseY = (int)((float)Main.mouseY + Main.screenPosition.Y);
							...
							if (Main.mouseRight && !this.mouseInterface)
							{
                                ...
                                Mod.OnRightClick(MouseX, MouseY);
							}
							if (this.controlInv)
							{
					...
					for (int n = 0; n < 10; n++)
					{
						...
						{
							if (this.whoAmi == Main.myPlayer && this.buffType[n] != 28)
							{
								this.buffTime[n]--;
							}
							if (this.buffType[n] == 1)
							{
							...
							{
								if (this.buffType[n] == 2)
								{
									this.lifeRegen += 2;
								}
								else
								{
									if (this.buffType[n] == 3)
									{
										this.moveSpeed += 0.25f;
									}
									else
									{
										if (this.buffType[n] == 4)
										{
											this.gills = true;
										}
										else
										{
											if (this.buffType[n] == 5)
											{
												this.statDefense += 8;
											}
											else
											{
												if (this.buffType[n] == 6)
												{
													this.manaRegenBuff = true;
												}
												else
												{
													if (this.buffType[n] == 7)
													{
														this.magicDamage += 0.2f;
													}
													else
													{
														if (this.buffType[n] == 8)
														{
															this.slowFall = true;
														}
														else
														{
															if (this.buffType[n] == 9)
															{
																this.findTreasure = true;
															}
															else
															{
																if (this.buffType[n] == 10)
																{
																	this.invis = true;
																}
																else
																{
																	if (this.buffType[n] == 11)
																	{
																		Lighting.addLight((int)(this.position.X + (float)(this.width / 2)) / 16, (int)(this.position.Y + (float)(this.height / 2)) / 16, 0.8f, 0.95f, 1f);
																	}
																	else
																	{
																		if (this.buffType[n] == 12)
																		{
																			this.nightVision = true;
																		}
																		else
																		{
																			if (this.buffType[n] == 13)
																			{
																				this.enemySpawns = true;
																			}
																			else
																			{
																				if (this.buffType[n] == 14)
																				{
																					this.thorns = true;
																				}
																				else
																				{
																					if (this.buffType[n] == 15)
																					{
																						this.waterWalk = true;
																					}
																					else
																					{
																						if (this.buffType[n] == 16)
																						{
																							this.archery = true;
																						}
																						else
																						{
																							if (this.buffType[n] == 17)
																							{
																								this.detectCreature = true;
																							}
																							else
																							{
																								if (this.buffType[n] == 18)
																								{
																									this.gravControl = true;
																								}
																								else
																								{
																									if (this.buffType[n] == 30)
																									{
																										this.bleed = true;
																									}
																									else
																									{
																										if (this.buffType[n] == 31)
																										{
																											this.confused = true;
																										}
																										else
																										{
																											if (this.buffType[n] == 32)
																											{
																												this.slow = true;
																											}
																											else
																											{
																												if (this.buffType[n] == 35)
																												{
																													this.silence = true;
																												}
																												else
																												{
																													if (this.buffType[n] == 36)
																													{
																														this.brokenArmor = true;
																													}
																													else
																													{
																														if (this.buffType[n] == 37)
																														{
																														...
																														else
																														{
																															...
																															{
																																if (this.buffType[n] == 19)
																																{
																																	this.lightOrb = true;
																																	bool flag6 = true;
																																	for (int num22 = 0; num22 < 1000; num22++)
																																	{
																																		if (Main.projectile[num22].active && Main.projectile[num22].owner == this.whoAmi && Main.projectile[num22].type == 18)
																																		{
																																			flag6 = false;
																																			break;
																																		}
																																...
																																{
																																	if (this.buffType[n] == 27)
																																	{
																																		this.fairy = true;
																																		bool flag7 = true;
																																		for (int num23 = 0; num23 < 1000; num23++)
																																		{
																																			if (Main.projectile[num23].active && Main.projectile[num23].owner == this.whoAmi && (Main.projectile[num23].type == 72 || Main.projectile[num23].type == 86 || Main.projectile[num23].type == 87))
																																			{
																																				flag7 = false;
																																				break;
																																			}
																																		...
																																		if (flag7)
																																		{
																																			...
																																			Projectile.NewProjectile(this.position.X + (float)(this.width / 2), this.position.Y + (float)(this.height / 2), 0f, 0f, num24, 0, 0f, this.whoAmi);
																																		}
																																	}
																																	else
																																	{
																																		if (this.buffType[n] == 40)
																																		{
																																			this.buffTime[n] = 18000;
																																			this.bunny = true;
																																			bool flag8 = true;
																																			for (int num25 = 0; num25 < 1000; num25++)
																																			{
																																				if (Main.projectile[num25].active && Main.projectile[num25].owner == this.whoAmi && Main.projectile[num25].type == 111)
																																				{
																																					flag8 = false;
																																					break;
																																				}
																																		...
																																		{
																																			if (this.buffType[n] == 20)
																																			{
																																				this.poisoned = true;
																																			}
																																			else
																																			{
																																				if (this.buffType[n] == 21)
																																				{
																																					this.potionDelay = this.buffTime[n];
																																				}
																																				else
																																				{
																																					if (this.buffType[n] == 22)
																																					{
																																						this.blind = true;
																																					}
																																					else
																																					{
																																						if (this.buffType[n] == 23)
																																						{
																																							this.noItems = true;
																																						}
																																						else
																																						{
																																							...
																																							{
																																								if (this.buffType[n] == 39)
																																								{
																																									this.onFire2 = true;
																																								}
																																								else
																																								{
																																									if (this.buffType[n] == 29)
																																									{
																																										this.magicCrit += 2;
					...
					while (this.lifeRegenCount <= -120)
					{
                        ...
                        //only apply to other players
                        if (this.whoAmi != Main.myPlayer)
                        {
                            this.statLife--;
                        }
                        //or self, if no god mode
                        else if (!Mod.GodMode)
                        {
                            this.statLife--;
                        }
					...
					while (this.manaRegenCount >= 120)
					{
						...
						if (this.statMana >= this.statManaMax2)
						{
							if (this.whoAmi == Main.myPlayer && flag9)
							{
								...
								{
									int num34 = Dust.NewDust(this.position, this.width, this.height, 45, 0f, 0f, 255, default(Color), (float)Main.rand.Next(20, 26) * 0.1f);
					...
					if (this.grappling[0] == -1 && !this.tongued)
					{
								...
								else
								{
									if (this.controlRight && this.velocity.X < num6)
									{
										...
										if (this.velocity.X > (num6 + num3) / 2f && this.velocity.Y == 0f)
										{
											...
											int num38 = Dust.NewDust(new Vector2(this.position.X - 4f, this.position.Y + (float)this.height + (float)num37), this.width + 8, 4, 16, -this.velocity.X * 0.5f, this.velocity.Y * 0.5f, 50, default(Color), 1.5f);
											Main.dust[num38].velocity.X = Main.dust[num38].velocity.X * 0.2f;
											Main.dust[num38].velocity.Y = Main.dust[num38].velocity.Y * 0.2f;
										}
									}
									else
									{
							...
							else
							{
								if ((this.velocity.Y == 0f || this.jumpAgain || (this.wet && this.accFlipper)) && this.releaseJump)
								{
									...
									else
									{
										...
										{
											int num41 = Dust.NewDust(new Vector2(this.position.X - 34f, this.position.Y + (float)num39 - 16f), 102, 32, 16, -this.velocity.X * 0.5f, this.velocity.Y * 0.5f, 100, default(Color), 1.5f);
											Main.dust[num41].velocity.X = Main.dust[num41].velocity.X * 0.5f - this.velocity.X * 0.1f;
											Main.dust[num41].velocity.Y = Main.dust[num41].velocity.Y * 0.5f - this.velocity.Y * 0.3f;
										}
										int num42 = Gore.NewGore(new Vector2(this.position.X + (float)(this.width / 2) - 16f, this.position.Y + (float)num39 - 16f), new Vector2(-this.velocity.X, -this.velocity.Y), Main.rand.Next(11, 14), 1f);
										Main.gore[num42].velocity.X = Main.gore[num42].velocity.X * 0.1f - this.velocity.X * 0.1f;
										Main.gore[num42].velocity.Y = Main.gore[num42].velocity.Y * 0.1f - this.velocity.Y * 0.05f;
										num42 = Gore.NewGore(new Vector2(this.position.X - 36f, this.position.Y + (float)num39 - 16f), new Vector2(-this.velocity.X, -this.velocity.Y), Main.rand.Next(11, 14), 1f);
										Main.gore[num42].velocity.X = Main.gore[num42].velocity.X * 0.1f - this.velocity.X * 0.1f;
										Main.gore[num42].velocity.Y = Main.gore[num42].velocity.Y * 0.1f - this.velocity.Y * 0.05f;
										num42 = Gore.NewGore(new Vector2(this.position.X + (float)this.width + 4f, this.position.Y + (float)num39 - 16f), new Vector2(-this.velocity.X, -this.velocity.Y), Main.rand.Next(11, 14), 1f);
										Main.gore[num42].velocity.X = Main.gore[num42].velocity.X * 0.1f - this.velocity.X * 0.1f;
										Main.gore[num42].velocity.Y = Main.gore[num42].velocity.Y * 0.1f - this.velocity.Y * 0.05f;
									}
								}
						...
						if (this.doubleJump && !this.jumpAgain && ((this.gravDir == 1f && this.velocity.Y < 0f) || (this.gravDir == -1f && this.velocity.Y > 0f)) && this.rocketBoots == 0 && !this.accFlipper)
						{
							...
							int num44 = Dust.NewDust(new Vector2(this.position.X - 4f, this.position.Y + (float)num43), this.width + 8, 4, 16, -this.velocity.X * 0.5f, this.velocity.Y * 0.5f, 100, default(Color), 1.5f);
							Main.dust[num44].velocity.X = Main.dust[num44].velocity.X * 0.5f - this.velocity.X * 0.1f;
							Main.dust[num44].velocity.Y = Main.dust[num44].velocity.Y * 0.5f - this.velocity.Y * 0.3f;
						}
						...
						if (this.rocketDelay > 0)
						{
							...
							for (int num46 = 0; num46 < 2; num46++)
							{
								...
								if (num46 == 0)
								{
									int num47 = Dust.NewDust(new Vector2(this.position.X - 4f, this.position.Y + (float)num45 - 10f), 8, 8, type3, 0f, 0f, alpha, default(Color), scale);
									if (this.rocketBoots == 1)
									{
									...
									if (this.rocketBoots == 2)
									{
										Main.dust[num47].velocity *= 0.1f;
									}
								}
								else
								{
									int num48 = Dust.NewDust(new Vector2(this.position.X + (float)this.width - 4f, this.position.Y + (float)num45 - 10f), 8, 8, type3, 0f, 0f, alpha, default(Color), scale);
									if (this.rocketBoots == 1)
									{
                        ...
                        if (this.gravDir == 1f)
                        {
                            ...
                            if (Mod.NoClip && this.whoAmi == Main.myPlayer)
                            {
                                this.velocity.Y = 0f;
                            }
                        }
					...
					for (int num49 = 0; num49 < 200; num49++)
					{
						...
						{
							if (new Rectangle((int)this.position.X, (int)this.position.Y, this.width, this.height).Intersects(new Rectangle((int)Main.item[num49].position.X, (int)Main.item[num49].position.Y, Main.item[num49].width, Main.item[num49].height)))
							{
							...
							{
								if (new Rectangle((int)this.position.X - Player.itemGrabRange, (int)this.position.Y - Player.itemGrabRange, this.width + Player.itemGrabRange * 2, this.height + Player.itemGrabRange * 2).Intersects(new Rectangle((int)Main.item[num49].position.X, (int)Main.item[num49].position.Y, Main.item[num49].width, Main.item[num49].height)) && this.ItemSpace(Main.item[num49]))
								{
					...
					if (Main.myPlayer == this.whoAmi)
					{
						...
						if (!this.immune)
						{
							...
							{
								if (Main.npc[num99].active && !Main.npc[num99].friendly && Main.npc[num99].damage > 0 && rectangle3.Intersects(new Rectangle((int)Main.npc[num99].position.X, (int)Main.npc[num99].position.Y, Main.npc[num99].width, Main.npc[num99].height)))
								{
									int num100 = -1;
					...
					if (vector5.Y != -1f && vector5.X != -1f)
					{
                        ...
                        //if noclip is off, apply velocity
                        if (!Mod.NoClip)
                        {
                            if (this.velocity.Y < 0f)
                            {
					...
					if (flag15 && Main.rand.Next(20) == 0 && !this.lavaWet)
					{
						...
						if (this.inventory[this.selectedItem].type == 186)
						{
							Dust.NewDust(new Vector2(this.position.X + (float)(10 * this.direction) + 4f, this.position.Y + (float)num121 - 54f * this.gravDir), this.width - 8, 8, 34, 0f, 0f, 0, default(Color), 1.2f);
						}
						else
						{
							Dust.NewDust(new Vector2(this.position.X + (float)(12 * this.direction), this.position.Y + (float)num121 + 4f * this.gravDir), this.width - 8, 8, 34, 0f, 0f, 0, default(Color), 1.2f);
						}
					}
					...
					bool flag16 = Collision.LavaCollision(this.position, this.width, num122);
					if (flag16)
					{
						...
						if (!this.wet)
						{
							if (this.wetCount == 0)
							{
								...
								if (!flag16)
								{
									...
									{
										int num125 = Dust.NewDust(new Vector2(this.position.X - 6f, this.position.Y + (float)(this.height / 2) - 8f), this.width + 12, 24, 33, 0f, 0f, 0, default(Color), 1f);
										Dust expr_8769_cp_0 = Main.dust[num125];
										expr_8769_cp_0.velocity.Y = expr_8769_cp_0.velocity.Y - 4f;
										Dust expr_8787_cp_0 = Main.dust[num125];
								...
								else
								{
									...
									{
										int num127 = Dust.NewDust(new Vector2(this.position.X - 6f, this.position.Y + (float)(this.height / 2) - 8f), this.width + 12, 24, 35, 0f, 0f, 0, default(Color), 1f);
										Dust expr_886F_cp_0 = Main.dust[num127];
										expr_886F_cp_0.velocity.Y = expr_886F_cp_0.velocity.Y - 1.5f;
										Dust expr_888D_cp_0 = Main.dust[num127];
						...
						if (this.wet)
						{
							...
							if (this.wetCount == 0)
							{
								...
								if (!this.lavaWet)
								{
									...
									{
										int num129 = Dust.NewDust(new Vector2(this.position.X - 6f, this.position.Y + (float)(this.height / 2)), this.width + 12, 24, 33, 0f, 0f, 0, default(Color), 1f);
										Dust expr_89C2_cp_0 = Main.dust[num129];
										expr_89C2_cp_0.velocity.Y = expr_89C2_cp_0.velocity.Y - 4f;
										Dust expr_89E0_cp_0 = Main.dust[num129];
								...
								else
								{
									...
									{
										int num131 = Dust.NewDust(new Vector2(this.position.X - 6f, this.position.Y + (float)(this.height / 2) - 8f), this.width + 12, 24, 35, 0f, 0f, 0, default(Color), 1f);
										Dust expr_8AC8_cp_0 = Main.dust[num131];
										expr_8AC8_cp_0.velocity.Y = expr_8AC8_cp_0.velocity.Y - 1.5f;
										Dust expr_8AE6_cp_0 = Main.dust[num131];
		...
		public double Hurt(int Damage, int hitDirection, bool pvp = false, bool quiet = false, string deathText = " was slain...", bool Crit = false)
		{
			if (!this.immune)
			{
				...
				if (num2 >= 1.0)
				{
                    ...
                    //if godmode is toggled and the player belongs to us
                    if (Mod.GodMode && this.whoAmi == Main.myPlayer)
                    {
                        //set health to full
                        this.statLife = this.statLifeMax;
                    }
                ...
                //again check for godmode to return that 0 damage was dealt
                if (Mod.GodMode && this.whoAmi == Main.myPlayer)
                {
                    num2 = 0;
                }
