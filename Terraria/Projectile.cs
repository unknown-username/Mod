	...
	public class Projectile
	{
		...
		public void AI()
		{
			if (this.aiStyle == 1)
			{
				...
				if (this.type == 41)
				{
					int num = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 31, 0f, 0f, 100, default(Color), 1.6f);
					Main.dust[num].noGravity = true;
					num = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 2f);
					Main.dust[num].noGravity = true;
				}
				else
				{
					if (this.type == 55)
					{
						int num2 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 18, 0f, 0f, 0, default(Color), 0.9f);
						Main.dust[num2].noGravity = true;
					}
					else
					{
						if (this.type == 91 && Main.rand.Next(2) == 0)
						{
							...
							int num4 = Dust.NewDust(this.position, this.width, this.height, num3, this.velocity.X * 0.25f, this.velocity.Y * 0.25f, 150, default(Color), 0.9f);
			...
			else
			{
				if (this.aiStyle == 2)
				{
					...
					{
						int num5 = Dust.NewDust(this.position, this.width, this.height, 57, this.velocity.X * 0.2f + (float)(this.direction * 3), this.velocity.Y * 0.2f, 100, default(Color), 0.3f);
				...
				else
				{
					if (this.aiStyle == 3)
					{
						...
						if (this.type == 19)
						{
							for (int i = 0; i < 2; i++)
							{
								int num6 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, default(Color), 2f);
						...
						else
						{
							if (this.type == 33)
							{
								...
								{
									int num7 = Dust.NewDust(this.position, this.width, this.height, 40, this.velocity.X * 0.25f, this.velocity.Y * 0.25f, 0, default(Color), 1.4f);
							...
							else
							{
								if (this.type == 6 && Main.rand.Next(5) == 0)
								{
									...
									Dust.NewDust(this.position, this.width, this.height, num8, this.velocity.X * 0.25f, this.velocity.Y * 0.25f, 150, default(Color), 0.7f);
								}
							}
						}
						if (this.ai[0] == 0f)
								...
								else
								{
									...
									else
									{
										if (this.aiStyle == 8)
										{
											...
											if (this.type == 27)
											{
												int num40 = Dust.NewDust(new Vector2(this.position.X + this.velocity.X, this.position.Y + this.velocity.Y), this.width, this.height, 29, this.velocity.X, this.velocity.Y, 100, default(Color), 3f);
												Main.dust[num40].noGravity = true;
												if (Main.rand.Next(10) == 0)
												{
													num40 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 29, this.velocity.X, this.velocity.Y, 100, default(Color), 1.4f);
												}
											}
											else
											{
												...
												{
													int num41 = Dust.NewDust(new Vector2(this.position.X + this.velocity.X, this.position.Y + this.velocity.Y), this.width, this.height, 75, this.velocity.X, this.velocity.Y, 100, default(Color), 3f * this.scale);
												...
												else
												{
													...
													{
														int num43 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, default(Color), 2f);
										...
										else
										{
											if (this.aiStyle == 9)
											{
												if (this.type == 34)
												{
													int num44 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, default(Color), 3.5f);
													Main.dust[num44].noGravity = true;
													Main.dust[num44].velocity *= 1.4f;
													num44 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, default(Color), 1.5f);
												}
												else
												{
													if (this.type == 79)
													{
														...
														for (int num45 = 0; num45 < 1; num45++)
														{
															...
															Main.dust[num46].velocity += this.velocity * 0.2f;
													...
													else
													{
														...
														int num47 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 15, 0f, 0f, 100, default(Color), 2f);
											...
											else
											{
												if (this.aiStyle == 10)
												{
													if (this.type == 31 && this.ai[0] != 2f)
													{
														if (Main.rand.Next(2) == 0)
														{
															int num64 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 32, 0f, this.velocity.Y / 2f, 0, default(Color), 1f);
													...
													else
													{
														if (this.type == 39)
														{
															if (Main.rand.Next(2) == 0)
															{
																int num65 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 38, 0f, this.velocity.Y / 2f, 0, default(Color), 1f);
														...
														else
														{
															if (this.type == 40)
															{
																if (Main.rand.Next(2) == 0)
																{
																	int num66 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 36, 0f, this.velocity.Y / 2f, 0, default(Color), 1f);
																	Main.dust[num66].velocity *= 0.4f;
																}
															}
															else
															{
																if (this.type == 42 || this.type == 31)
																{
																	if (Main.rand.Next(2) == 0)
																	{
																		int num67 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 32, 0f, 0f, 0, default(Color), 1f);
																...
																else
																{
																	if (this.type == 56 || this.type == 65)
																	{
																		if (Main.rand.Next(2) == 0)
																		{
																			int num68 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 14, 0f, 0f, 0, default(Color), 1f);
																	...
																	else
																	{
																		if (this.type == 67 || this.type == 68)
																		{
																			if (Main.rand.Next(2) == 0)
																			{
																				int num69 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 51, 0f, 0f, 0, default(Color), 1f);
																		...
																		else
																		{
																			if (this.type == 71)
																			{
																				if (Main.rand.Next(2) == 0)
																				{
																					int num70 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 53, 0f, 0f, 0, default(Color), 1f);
													...
													if (this.aiStyle == 11)
													{
														if (this.type == 72 || this.type == 86 || this.type == 87)
														{
															...
															if (Main.rand.Next(6) == 0)
															{
																...
																int num76 = Dust.NewDust(this.position, this.width, this.height, num75, 0f, 0f, 200, default(Color), 0.8f);
													...
													else
													{
														if (this.aiStyle == 12)
														{
															...
															if (this.ai[0] > 4f)
															{
																this.alpha = 150;
																this.light = 0.8f;
																int num82 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 29, this.velocity.X, this.velocity.Y, 100, default(Color), 2.5f);
																Main.dust[num82].noGravity = true;
																Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 29, this.velocity.X, this.velocity.Y, 100, default(Color), 1.5f);
															}
															else
															{
																this.ai[0] += 1f;
															...
															if (this.aiStyle == 14)
															{
																if (this.type == 53)
																{
																	try
																	{
                                                                        ...
                                                                        //commenting this out, if crashes occur, this could be why
															...
															else
															{
																if (this.aiStyle == 15)
																{
																	...
																	else
																	{
																		if (this.type == 26)
																		{
																			int num93 = Dust.NewDust(this.position, this.width, this.height, 29, this.velocity.X * 0.4f, this.velocity.Y * 0.4f, 100, default(Color), 2.5f);
																		...
																		else
																		{
																			if (this.type == 35)
																			{
																				int num94 = Dust.NewDust(this.position, this.width, this.height, 6, this.velocity.X * 0.4f, this.velocity.Y * 0.4f, 100, default(Color), 3f);
																...
																else
																{
																	...
																	else
																	{
																		if (this.aiStyle == 18)
																		{
																			...
																			{
																				int num115 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 27, 0f, 0f, 100, default(Color), 1f);
																		...
																		if (this.aiStyle == 19)
																		{
																			...
																			if (this.type == 46)
																			{
																				...
																				int num116 = Dust.NewDust(this.position, this.width, this.height, 27, this.velocity.X * 0.2f + (float)(this.direction * 3), this.velocity.Y * 0.2f, 100, default(Color), 1.2f);
																				...
																				num116 = Dust.NewDust(this.position - this.velocity * 2f, this.width, this.height, 27, 0f, 0f, 150, default(Color), 1.4f);
																			...
																			if (this.type == 105)
																			{
																				if (Main.rand.Next(3) == 0)
																				{
																					int num117 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 57, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 200, default(Color), 1.2f);
																					Main.dust[num117].velocity += this.velocity * 0.3f;
																					Main.dust[num117].velocity *= 0.2f;
																				}
																				if (Main.rand.Next(4) == 0)
																				{
																					int num118 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 43, 0f, 0f, 254, default(Color), 0.3f);
																					Main.dust[num118].velocity += this.velocity * 0.5f;
																					Main.dust[num118].velocity *= 0.5f;
																					return;
																				}
																			}
																		}
																		else
																		{
																			if (this.aiStyle == 20)
																			{
																				...
																				if (Main.rand.Next(6) == 0)
																				{
																					int num123 = Dust.NewDust(this.position + this.velocity * (float)Main.rand.Next(6, 10) * 0.1f, this.width, this.height, 31, 0f, 0f, 80, default(Color), 1.4f);
																			...
																			else
																			{
																				if (this.aiStyle == 21)
																				{
																					...
																					if (Main.rand.Next(3) == 0)
																					{
																						int num124 = Dust.NewDust(this.position, this.width, this.height, 27, 0f, 0f, 80, default(Color), 1f);
																						Main.dust[num124].noGravity = true;
																						Main.dust[num124].velocity *= 0.2f;
																					}
																					if (this.ai[1] == 1f)
																					{
																						this.ai[1] = 0f;
																				...
																				else
																				{
																					if (this.aiStyle == 22)
																					{
																						...
																						if (this.ai[1] < 0f)
																						{
																							...
																							int num133 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 67, 0f, 0f, 0, default(Color), 1f);
																						...
																						if (this.ai[0] < 0f)
																						{
																							if (this.ai[0] == -1f)
																							{
																								...
																								{
																									int num135 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 67, 0f, 0f, 0, default(Color), 1.1f);
																							...
																							else
																							{
																								...
																								{
																									int num136 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 67, 0f, 0f, 100, default(Color), 1f);
																						...
																						else
																						{
																							...
																							if (this.active)
																							{
																								int num147 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 67, 0f, 0f, 0, default(Color), 1f);
																					...
																					else
																					{
																						if (this.aiStyle == 23)
																						{
																							...
																							if (this.ai[0] > 7f)
																							{
																								...
																								if (num153 == 6 || Main.rand.Next(2) == 0)
																								{
																									...
																									{
																										int num155 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, num153, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, default(Color), 1f);
																										...
																										if (num153 == 75)
																										{
																											Main.dust[num155].velocity += this.velocity;
																						...
																						if (this.aiStyle == 24)
																						{
																							...
																							if (this.type == 94)
																							{
																								if (Main.rand.Next(4) == 0)
																								{
																									int num156 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 70, 0f, 0f, 0, default(Color), 1f);
																									Main.dust[num156].noGravity = true;
																									Main.dust[num156].velocity *= 0.5f;
																						...
																						else
																						{
																							...
																							if (this.aiStyle == 26)
																							{
																								...
																								if (this.ai[0] != 0f)
																								{
																									...
																									int num167 = Dust.NewDust(new Vector2(this.position.X + (float)(this.width / 2) - 4f, this.position.Y + (float)(this.height / 2) - 4f) - this.velocity, 8, 8, 16, -this.velocity.X * 0.5f, this.velocity.Y * 0.5f, 50, default(Color), 1.7f);
			...
			else
			{
				...
				else
				{
					if (this.type == 93)
					{
						...
						for (int j = 0; j < 10; j++)
						{
							int num2 = Dust.NewDust(this.position, this.width, this.height, 57, 0f, 0f, 100, default(Color), 0.5f);
					...
					else
					{
						if (this.type == 99)
						{
							...
							for (int k = 0; k < 30; k++)
							{
								int num3 = Dust.NewDust(this.position, this.width, this.height, 1, 0f, 0f, 0, default(Color), 1f);
								if (Main.rand.Next(2) == 0)
								{
						...
						else
						{
							...
							else
							{
								if (this.type == 89)
								{
									...
									{
										int num12 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 68, 0f, 0f, 0, default(Color), 1f);
								...
								else
								{
									...
									else
									{
										if (this.type == 76 || this.type == 77 || this.type == 78)
										{
											...
											{
												int num20 = Dust.NewDust(this.position, this.width, this.height, 27, 0f, 0f, 80, default(Color), 1.5f);
										...
										else
										{
											if (this.type == 55)
											{
												...
												{
													int num22 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 18, 0f, 0f, 0, default(Color), 1.5f);
												...
												else
												{
													...
													else
													{
														if (this.type == 103)
														{
															...
															{
																int num26 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 75, 0f, 0f, 100, default(Color), 1f);
																if (Main.rand.Next(2) == 0)
																{
																	Main.dust[num26].scale *= 2.5f;
																	Main.dust[num26].noGravity = true;
																	Main.dust[num26].velocity *= 5f;
																}
															}
														}
														else
																...
																else
																{
																	if (this.type == 5)
																	{
																		...
																		for (int num29 = 0; num29 < 60; num29++)
																		{
																			...
																			Dust.NewDust(this.position, this.width, this.height, num30, this.velocity.X * 0.5f, this.velocity.Y * 0.5f, 150, default(Color), 1.5f);
																		}
																	}
																	else
																	{
																		...
																		else
																		{
																			...
																			else
																			{
																				if (this.type == 15 || this.type == 34)
																				{
																					...
																					{
																						int num36 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, -this.velocity.X * 0.2f, -this.velocity.Y * 0.2f, 100, default(Color), 2f);
																						Main.dust[num36].noGravity = true;
																						Main.dust[num36].velocity *= 2f;
																						num36 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, -this.velocity.X * 0.2f, -this.velocity.Y * 0.2f, 100, default(Color), 1f);
																						Main.dust[num36].velocity *= 2f;
																					}
																				}
																				else
																				{
																					if (this.type == 95 || this.type == 96)
																					{
																						...
																						{
																							int num38 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 75, -this.velocity.X * 0.2f, -this.velocity.Y * 0.2f, 100, default(Color), 2f * this.scale);
																							Main.dust[num38].noGravity = true;
																							Main.dust[num38].velocity *= 2f;
																							num38 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 75, -this.velocity.X * 0.2f, -this.velocity.Y * 0.2f, 100, default(Color), 1f * this.scale);
																							Main.dust[num38].velocity *= 2f;
																						}
																					}
																					else
																					{
																						...
																						else
																						{
																							if (this.type == 16)
																							{
																								...
																								{
																									int num42 = Dust.NewDust(new Vector2(this.position.X - this.velocity.X, this.position.Y - this.velocity.Y), this.width, this.height, 15, 0f, 0f, 100, default(Color), 2f);
																									Main.dust[num42].noGravity = true;
																									Main.dust[num42].velocity *= 2f;
																									num42 = Dust.NewDust(new Vector2(this.position.X - this.velocity.X, this.position.Y - this.velocity.Y), this.width, this.height, 15, 0f, 0f, 100, default(Color), 1f);
																								}
																							}
																							else
																							{
																								...
																								else
																								{
																									if (this.type == 31 || this.type == 42)
																									{
																										...
																										{
																											int num45 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 32, 0f, 0f, 0, default(Color), 1f);
																											Main.dust[num45].velocity *= 0.6f;
																										}
																									}
																									else
																									{
																										if (this.type == 109)
																										{
																											...
																											{
																												int num47 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 51, 0f, 0f, 0, default(Color), 0.6f);
																												Main.dust[num47].velocity *= 0.6f;
																											}
																										}
																										else
																										{
																											if (this.type == 39)
																											{
																												...
																												{
																													int num49 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 38, 0f, 0f, 0, default(Color), 1f);
																													Main.dust[num49].velocity *= 0.6f;
																												}
																											}
																											else
																											{
																												if (this.type == 71)
																												{
																													...
																													{
																														int num51 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 53, 0f, 0f, 0, default(Color), 1f);
																														Main.dust[num51].velocity *= 0.6f;
																													}
																												}
																												else
																												{
																													if (this.type == 40)
																													{
																														...
																														{
																															int num53 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 36, 0f, 0f, 0, default(Color), 1f);
																															Main.dust[num53].velocity *= 0.6f;
																														}
																													}
																													else
																													{
																														...
																														else
																														{
																															...
																															else
																															{
																																if (this.type == 27)
																																{
																																	...
																																	{
																																		int num57 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 29, this.velocity.X * 0.1f, this.velocity.Y * 0.1f, 100, default(Color), 3f);
																																		Main.dust[num57].noGravity = true;
																																		Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 29, this.velocity.X * 0.1f, this.velocity.Y * 0.1f, 100, default(Color), 2f);
																																	}
																																}
																																else
																																{
																																	...
																																	else
																																	{
																																		if (this.type == 44 || this.type == 45)
																																		{
																																			...
																																			{
																																				int num60 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 27, this.velocity.X, this.velocity.Y, 100, default(Color), 1.7f);
																																		...
																																		else
																																		{
																																			if (this.type == 41)
																																			{
																																				...
																																				{
																																					int num63 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 2.5f);
																																					Main.dust[num63].noGravity = true;
																																					Main.dust[num63].velocity *= 3f;
																																					num63 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 1.5f);
																																					Main.dust[num63].velocity *= 2f;
																																				}
																																				int num64 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), default(Vector2), Main.rand.Next(61, 64), 1f);
																																				Main.gore[num64].velocity *= 0.4f;
																																				...
																																				num64 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), default(Vector2), Main.rand.Next(61, 64), 1f);
																																				Main.gore[num64].velocity *= 0.4f;
																																			...
																																			else
																																			{
																																				if (this.type == 28 || this.type == 30 || this.type == 37 || this.type == 75 || this.type == 102)
																																				{
																																					...
																																					{
																																						int num66 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 31, 0f, 0f, 100, default(Color), 1.5f);
																																						Main.dust[num66].velocity *= 1.4f;
																																					}
																																					for (int num67 = 0; num67 < 10; num67++)
																																					{
																																						int num68 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 2.5f);
																																						Main.dust[num68].noGravity = true;
																																						Main.dust[num68].velocity *= 5f;
																																						num68 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 1.5f);
																																						Main.dust[num68].velocity *= 3f;
																																					}
																																					int num69 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), default(Vector2), Main.rand.Next(61, 64), 1f);
																																					Main.gore[num69].velocity *= 0.4f;
																																					...
																																					num69 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), default(Vector2), Main.rand.Next(61, 64), 1f);
																																					Main.gore[num69].velocity *= 0.4f;
																																				...
																																				else
																																				{
																																					if (this.type == 29 || this.type == 108)
																																					{
																																						...
																																						{
																																							int num71 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 31, 0f, 0f, 100, default(Color), 2f);
																																							Main.dust[num71].velocity *= 1.4f;
																																						}
																																						for (int num72 = 0; num72 < 80; num72++)
																																						{
																																							int num73 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 3f);
																																							Main.dust[num73].noGravity = true;
																																							Main.dust[num73].velocity *= 5f;
																																							num73 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, default(Color), 2f);
																																							Main.dust[num73].velocity *= 3f;
																																						}
																																						for (int num74 = 0; num74 < 2; num74++)
																																						{
																																							int num75 = Gore.NewGore(new Vector2(this.position.X + (float)(this.width / 2) - 24f, this.position.Y + (float)(this.height / 2) - 24f), default(Vector2), Main.rand.Next(61, 64), 1f);
																																							...
																																							num75 = Gore.NewGore(new Vector2(this.position.X + (float)(this.width / 2) - 24f, this.position.Y + (float)(this.height / 2) - 24f), default(Vector2), Main.rand.Next(61, 64), 1f);
																																							Main.gore[num75].scale = 1.5f;
																																					...
																																					else
																																					{
																																						if (this.type == 69)
																																						{
																																							...
																																							{
																																								int num78 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 33, 0f, -2f, 0, default(Color), 1.1f);
																																						...
																																						else
																																						{
																																							if (this.type == 70)
																																							{
																																								...
																																								{
																																									int num81 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 52, 0f, -2f, 0, default(Color), 1.1f);
